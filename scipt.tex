...
Backpropagation is an algorithm to tweak weights of a neural network to minimize the cost function on a training set, containing input vectors and the corresponding desired outputs.  For backpropagation we limit the $\sigma$'s of feedforward neural networks to be differentiable.
